...
type Function interface {
	Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool)
}
...
func (this MaxFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
...
func (this MinFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
	vs, isEnough = L.HistoryData(this.Limit)
	if !isEnough {
		return
	}
...
func (this AllFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
	vs, isEnough = L.HistoryData(this.Limit)
	if !isEnough {
		return
	}
...
func (this LookupFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
	vs, isEnough = L.HistoryData(this.Limit)
	if !isEnough {
		return
	}
...
func (this SumFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
	vs, isEnough = L.HistoryData(this.Limit)
	if !isEnough {
		return
	}
...
func (this AvgFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
	vs, isEnough = L.HistoryData(this.Limit)
	if !isEnough {
		return
	}
...
// 只要有一个点的diff触发阈值，就报警
func (this DiffFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
...
func (this PDiffFunction) Compute(L *SafeLinkedList) (vs []*g.HistoryData, leftValue float64, isTriggered bool, isEnough bool) {
	vs, isEnough = L.HistoryData(this.Limit + 1)
	if !isEnough {
		return
	}
